...
// so I added a list of insurance providers to select from, and also added a list of identification types to select from, and also added a list of doctors to select from based on the department they belong to
