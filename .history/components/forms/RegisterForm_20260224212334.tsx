...
const RegisterForm = ({ user }: { user: User }) => {
 ...
 const onSubmit = async (values: PatientFormValues) => {
    console.log("Submit triggered!"); // If you don't see this in console, validation failed
    setIsLoading(true);
    ...
    try {
      const patient = {
        ...
        gender: (values.gender as string).toLowerCase() as Gender,
        ...
        <section className="space-y-6">
          ...
          <div className="flex flex-col gap-6 xl:flex-row">
            <CustomFormField
              ...
              name="address"
              label="Address"
              placeholder="Gate 78, Manyani road, Westlands"
            />
